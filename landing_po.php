...
<head>
    ...
    <title>Landing Product Owners</title>
    <style>
        .centered-message {
            position: fixed;
            top: 50%;
...
<body class="bg-white from-indigo-500 to-green-500 bg-no-repeat h-fit	">
    ...
    <div class="flex-1">
        <?php
        // Render tables
        $projectManagement->renderProjectsTable($resultProjects);
        $projectManagement->renderMembersTable($resultMembers);
        $projectManagement->renderScrumMastersTable($resultScrumMasters);
        $projectManagement->renderTeamsTable($resultTeams);
        ?>
    </div>
