...
$projectManagement = new ProjectManagement($con);
$resultProjects = $projectManagement->getProjects();
$resultMembers = $projectManagement->getMembers();
$resultScrumMasters = $projectManagement->getScrumMasters();
$resultTeams = $projectManagement->getTeams();
?>
...
<head>
    ...
    <title>Landing Scrum Masters</title>
    <style>
        .centered-message {
            position: fixed;
            top: 50%;
...
<body class="bg-white from-indigo-500 to-green-500 bg-no-repeat h-fit	">
    <header class="antialiased">
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center">
                    ...
                    <a href="addTeam.php">
                    <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-r from-indigo-500 to-green-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
    ...
    <div class="flex-1">
         <!-- Render tables -->
        <?php $projectManagement->renderProjectsTable($resultProjects); ?>
        <?php $projectManagement->renderMembersTable($resultMembers); ?>
        <?php $projectManagement->renderScrumMastersTable($resultScrumMasters); ?>
        <?php $projectManagement->renderTeamsTable($resultTeams); ?>
    </div>
